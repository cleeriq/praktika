...
$(document).on("click", ".change-btn", function() {
            ...
            <form id="changeForm">
                ...
                <div>
                    <select name="employeeSelect1">
                        ...
                        <option value="2">Иванов Иван1</option>
                        <option value="3">Иванов Иван2</option>
                        <option value="4">Иванов Иван3</option>
                    </select>
                </div>
    ...
    employees.forEach(function(item, i, arr) {
        ...
        <label> `+ item.innerText +`
            <input type="checkbox" value="`+item.value+`" name="employees">
